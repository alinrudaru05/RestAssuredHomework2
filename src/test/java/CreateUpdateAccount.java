...
public class CreateUpdateAccount {
    ...
    public void createAndUpdateAccount(){
        ...
        //Verificam ca respectiv contul nostru a fost inserat cu succes
        Account actualAccount = getAccount.extract().as(Account.class);
        assertThat(actualAccount, is(account));

        //update my account
        account.setName("Rudaru Alin Ionut");
        account.setPassword("RestAssured2020");
        ...
        ValidatableResponse getAccountUpdated = given()
                .baseUri(EnvReader.getBaseUri())
                .auth().oauth2("455136538609782|4fdbc3c6f529deaf84edc82aee315790")
                .pathParam("test-user-id", account.getUid())
                .log().all()
        ...
        //verificam ca, respectiv contul nostru a fost updatat cu succes
        Account actualAccountUpdated = getAccountUpdated.extract().as(Account.class);
        assertThat(actualAccountUpdated, is(account));
